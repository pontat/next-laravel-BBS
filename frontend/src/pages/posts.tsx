      ...
      <div className="mt-5 shadow rounded overflow-hidden">
        <div className="p-4 bg-white space-y-6">
          <div>
            ...
            <input type="text" id="title" placeholder="タイトルを入力" className="w-full p-3 bg-white text-sm border border-blueGray-300 rounded" />
          </div>
          <div>
            <label htmlFor="content" className="text-sm font-bold text-gray-900">
              内容
            </label>
            <textarea id="content" rows={5} placeholder="内容を入力" className="w-full p-3 bg-white text-sm border border-blueGray-300 rounded"></textarea>
          </div>
        </div>
        <div className="flex justify-between px-4 py-3 bg-gray-100">
          <button className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-sm font-bold text-white rounded shadow hover:shadow-md">投稿する</button>
          <Link href="/">
